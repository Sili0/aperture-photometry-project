...
A représente le filtre donné. Effectivement, dans une plage de longueur d'onde donné, le flux d'une étoile n'est pas le même. Il faut donc définir dans quelle plage de longueur d'onde on se trouve.
...
Supprimer $n_{0, A}$ nous permet de corriger le fond de ciel, nous pouvons alors définir la magnitude instrumentale (et apparente) comme :
\begin{equation}
